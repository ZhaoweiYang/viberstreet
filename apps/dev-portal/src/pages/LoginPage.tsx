  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-violet-600/20 via-transparent to-transparent rounded-full blur-3xl" />
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-8">
          ...
          {!codeSent ? (
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-1">{t('login.verification_code')}</label>
                <input
                  type="text"
                  required
                  value={code}
                  ...
                  maxLength={6}
                  autoFocus
                  className="w-full px-4 py-2.5 bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-center text-2xl tracking-widest font-mono"
                />
              </div>
              <button
                type="submit"
          ...
          <button disabled className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-700 rounded-xl text-sm font-medium text-slate-400 disabled:opacity-50 hover:bg-slate-800 transition-colors">
